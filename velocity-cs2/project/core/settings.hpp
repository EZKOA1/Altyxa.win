...
namespace settings {
	...
	struct combat
	{
		struct ragebot
		{
			...
			struct weapon_group
			{
				...
				xui::setting autoscope{ true, {}, "autoscope", "ragebot" };

				xui::setting autostop{ true, {}, "autostop", "ragebot" };
				xui::setting autostop_early{ false, {}, "autostop early", "ragebot" };
				xui::setting autostop_in_air{ false, {}, "autostop in air", "ragebot" };
				xui::setting autostop_duck{ false, {}, "autostop duck", "ragebot" };
				xui::setting autostop_move_between_shots{ false, {}, "move between shots", "ragebot" };
			...
			void init( std::string_view cat )
			{
				...
				this->autostop_in_air.category = s;
				this->autostop_duck.category = s;
				this->autostop_move_between_shots.category = s;
		...
		struct antiaim
		{
			...
			xui::setting hide_shots{ true, {}, "hideshots", "anti aim" };
			xui::setting avoid_backstab{ true, {}, "avoid backstab", "anti aim" };
			xui::setting at_target{ true, {}, "at target", "anti aim" };
		...
		struct penetration_crosshair
		{
			...
			config::enm<style> crosshair_style{ style::square, "pen crosshair", "style" };
			xui::setting physics{ true, {}, "world physics", "pen crosshair" };
			...
			config::val<float> size{ 6.0f, "pen crosshair", "size" };
	...
	struct esp
	{
		...
		struct player
		{
			...
			struct chams
			{
				...
				chams_config enemy_ragdoll
				{
					...
					.primary = {.enabled = { false, {}, "primary layer", "chams enemy ragdoll" }, .color = { { 173, 192, 255, 75 }, "chams enemy ragdoll", "primary color" }, .material = { cham_ids::flat, "chams enemy ragdoll", "primary material" } },
					.secondary = {.enabled = { false, {}, "secondary layer", "chams enemy ragdoll" }, .color = { { 173, 192, 255, 255 }, "chams enemy ragdoll", "secondary color" }, .material = { cham_ids::outlines, "chams enemy ragdoll", "secondary material" } },
					.overlay = {.enabled = { false, {}, "overlay layer", "chams enemy ragdoll" }, .color = { { 173, 192, 255, 175 }, "chams enemy ragdoll", "overlay color" }, .material = { cham_ids::outlines, "chams enemy ragdoll", "overlay material" } }
				};
				chams_config team
				{
					.enabled = { false, {}, "chams", "chams team" },
					.primary = {.enabled = { false, {}, "primary layer", "chams team" }, .color = { { 173, 192, 255, 150 }, "chams team", "primary color" }, .material = { cham_ids::flat, "chams team", "primary material" } },
					.secondary = {.enabled = { false, {}, "secondary layer", "chams team" }, .color = { { 255, 208, 243, 118 }, "chams team", "secondary color" }, .material = { cham_ids::flat_ignorez, "chams team", "secondary material" } },
					.overlay = {.enabled = { false, {}, "overlay layer", "chams team" }, .color = { { 173, 192, 255, 175 }, "chams team", "overlay color" }, .material = { cham_ids::outlines, "chams team", "overlay material" } }
				};
				chams_config team_ragdoll
				{
					.enabled = { false, {}, "ragdoll chams", "chams team ragdoll" },
					.primary = {.enabled = { false, {}, "primary layer", "chams team ragdoll" }, .color = { { 173, 192, 255, 75 }, "chams team ragdoll", "primary color" }, .material = { cham_ids::flat, "chams team ragdoll", "primary material" } },
					.secondary = {.enabled = { false, {}, "secondary layer", "chams team ragdoll" }, .color = { { 173, 192, 255, 255 }, "chams team ragdoll", "secondary color" }, .material = { cham_ids::outlines, "chams team ragdoll", "secondary material" } },
					.overlay = {.enabled = { false, {}, "overlay layer", "chams team ragdoll" }, .color = { { 173, 192, 255, 175 }, "chams team ragdoll", "overlay color" }, .material = { cham_ids::outlines, "chams team ragdoll", "overlay material" } }
				};
				chams_config local
				{
					...
					.primary = {.enabled = { false, {}, "primary layer", "chams local" }, .color = { { 173, 192, 255, 150 }, "chams local", "primary color" }, .material = { cham_ids::flat, "chams local", "primary material" } },
					.secondary = {.enabled = { false, {}, "secondary layer", "chams local" }, .color = { { 255, 208, 243, 118 }, "chams local", "secondary color" }, .material = { cham_ids::flat_ignorez, "chams local", "secondary material" } }
				};
				chams_config local_ragdoll
				{
					.enabled = { false, {}, "ragdoll chams", "chams local ragdoll" },
					.primary = {.enabled = { false, {}, "primary layer", "chams local ragdoll" }, .color = { { 173, 192, 255, 75 }, "chams local ragdoll", "primary color" }, .material = { cham_ids::flat, "chams local ragdoll", "primary material" } },
					.secondary = {.enabled = { false, {}, "secondary layer", "chams local ragdoll" }, .color = { { 173, 192, 255, 255 }, "chams local ragdoll", "secondary color" }, .material = { cham_ids::outlines, "chams local ragdoll", "secondary material" } },
					.overlay = {.enabled = { false, {}, "overlay layer", "chams local ragdoll" }, .color = { { 173, 192, 255, 175 }, "chams local ragdoll", "overlay color" }, .material = { cham_ids::outlines, "chams local ragdoll", "overlay material" } }
				};
		...
		struct viewmodel
		{
			chams_config weapon
			{
				...
				.primary = {.enabled = { false, {}, "primary layer", "viewmodel weapon" }, .color = { { 173, 192, 255, 255 }, "viewmodel weapon", "primary color" }, .material = { cham_ids::outlines, "viewmodel weapon", "primary material" } },
				.secondary = {.enabled = { false, {}, "secondary layer", "viewmodel weapon" }, .color = { { 255, 208, 243, 118 }, "viewmodel weapon", "secondary color" }, .material = { cham_ids::flat_ignorez, "viewmodel weapon", "secondary material" } }
			};
			chams_config arms
			{
				...
				.secondary = {.enabled = { false, {}, "secondary layer", "viewmodel arms" }, .color = { { 255, 100, 100, 100 }, "viewmodel arms", "secondary color" }, .material = { cham_ids::flat_ignorez, "viewmodel arms", "secondary material" } }
			};
		} m_viewmodel{};
			...
			struct chams
			{
				...
				chams( )
				{
					for ( auto i = 0u; i < k_group_count; ++i )
					{
						...
						this->groups[ i ].overlay.init( cat, "overlay layer" );
					}
			...
			struct glow
			{
				...
				glow( )
				{
					for ( auto i = 0u; i < k_group_count; ++i )
					{
						...
						this->groups[ i ].init( cat, "color", "glow" );
					}
	...
	struct misc
	{
		...
		struct automessage
		{
			static constexpr auto k_max_phrases{ 10 };

			xui::setting enabled{ false, {}, "auto message", "automessage" };
			xui::setting team_only{ false, {}, "team only", "automessage" };

			enum class mode_type : std::uint8_t { random, sequential };
			config::enm<mode_type> mode{ mode_type::random, "automessage", "mode" };

			std::array<config::str, k_max_phrases> phrases{ {
				{ "gg ez", "automessage", "phrase 1" },
				{ "nice try", "automessage", "phrase 2" },
				{ "get rekt", "automessage", "phrase 3" },
				{ "too easy", "automessage", "phrase 4" },
				{ "velocity on top", "automessage", "phrase 5" },
				{ "", "automessage", "phrase 6" },
				{ "", "automessage", "phrase 7" },
				{ "", "automessage", "phrase 8" },
				{ "", "automessage", "phrase 9" },
				{ "", "automessage", "phrase 10" }
			} };

			[[nodiscard]] std::vector<std::string> get_active_phrases( ) const
			{
				std::vector<std::string> result{};
				for ( const auto& p : this->phrases )
				{
					if ( !p.value.empty( ) )
					{
