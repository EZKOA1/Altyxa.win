...
namespace steam {
	...
	const char* friends::get_friend_persona_name (std::uint64_t steam_id) {
		return memory::call<const char*> (MODULE_EXPORT ("steam_api64.dll:SteamAPI_ISteamFriends_GetFriendPersonaName"), detail::friends_interface, steam_id);
	}
